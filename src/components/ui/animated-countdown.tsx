...
function CountdownNumber({ value, className }: { value: string; className?: string }) {
  ...
  return (
    <span
      className={cn('relative inline-grid min-w-[2ch] place-items-center tabular-nums', className)}
    >
    ...
    >
      ...
      <CountdownNumber
        ...
        className={cn(
          ...
          variant === 'digital' &&
            'font-mono text-cyan-100 drop-shadow-[0_0_18px_rgba(34,211,238,0.45)]',
